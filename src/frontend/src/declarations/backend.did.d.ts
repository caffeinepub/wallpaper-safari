...
export interface _SERVICE {
  ...
  'deleteWallpaper' : ActorMethod<[string], undefined>,
  'downloadWallpaper' : ActorMethod<[string], undefined>,
  'getAllWallpapers' : ActorMethod<[], Array<Wallpaper>>,
  'getCallerUserProfile' : ActorMethod<[], [] | [UserProfile]>,
  'getCallerUserRole' : ActorMethod<[], UserRole>,
  'getUserProfile' : ActorMethod<[Principal], [] | [UserProfile]>,
  'getWallpaper' : ActorMethod<[string], [] | [Wallpaper]>,
  'isCallerAdmin' : ActorMethod<[], boolean>,
  'likeWallpaper' : ActorMethod<[string], undefined>,
